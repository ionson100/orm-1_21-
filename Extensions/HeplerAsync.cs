...
namespace ORM_1_21_
{
    public static partial class Helper
    {
        ...
        /// </summary>
        public static Task<int> AverageAsync<TSource>(this IQueryable<TSource> source,
            Expression<Func<TSource, int>> selector, CancellationToken cancellationToken = default)
        {
            Check.NotNull(source, "source");
            Check.NotNull(selector, "selector");
        ...
        /// </summary>
        public static Task<long> AverageAsync<TSource>(this IQueryable<TSource> source,
            Expression<Func<TSource, long>> selector, CancellationToken cancellationToken = default)
        {
            Check.NotNull(source, "source");
            Check.NotNull(selector, "selector");
            ...
            Func<TSource, TElement> elementSelector, CancellationToken cancellationToken = default)
        {
            ...
            await source.ForEachAsync(element => { d.Add(keySelector(element), elementSelector(element)); },
            ...
            Func<TSource, TKey> keySelector, CancellationToken cancellationToken = default)
        {
            ...
            await source.ForEachAsync(element => { d.Add(keySelector(element), element); },
                cancellationToken: cancellationToken);
            return d;
        }
        ...
        private static readonly MethodInfo _firstOrDefault_Predicate = GetMethod("FirstOrDefault", (Type T) =>
            new Type[2]
            {
                typeof(IQueryable<>).MakeGenericType(T),
                typeof(Expression<>).MakeGenericType(typeof(Func<,>).MakeGenericType(T, typeof(bool)))
        ...
        private static readonly MethodInfo _singleOrDefault_Predicate = GetMethod("SingleOrDefault", (Type T) =>
            new Type[2]
            {
                typeof(IQueryable<>).MakeGenericType(T),
                typeof(Expression<>).MakeGenericType(typeof(Func<,>).MakeGenericType(T, typeof(bool)))
        ...
        private static readonly MethodInfo _average_FloatNullable_Selector = GetMethod("Average", (Type T) =>
            new Type[2]
            {
                typeof(IQueryable<>).MakeGenericType(T),
                typeof(Expression<>).MakeGenericType(typeof(Func<,>).MakeGenericType(T, typeof(float?)))
        ...
        private static readonly MethodInfo _average_DoubleNullable_Selector = GetMethod("Average", (Type T) =>
            new Type[2]
            {
                typeof(IQueryable<>).MakeGenericType(T),
                typeof(Expression<>).MakeGenericType(typeof(Func<,>).MakeGenericType(T, typeof(double?)))
        ...
        private static readonly MethodInfo _average_DecimalNullable_Selector = GetMethod("Average", (Type T) =>
            new Type[2]
            {
                typeof(IQueryable<>).MakeGenericType(T),
                typeof(Expression<>).MakeGenericType(typeof(Func<,>).MakeGenericType(T, typeof(decimal?)))
        ...
        private static MethodInfo GetMethod(string methodName, Delegate getParameterTypesDelegate,

...
namespace TestLibrary
{
   public static class ConnectionStrings
    {
        ...
        public const string Postgesql =
            "Server=localhost;Port=5432;Database=test_geo;User Id=user;Password=postgres;";
  ...
  public class MyDbPostgresGeo : IOtherDataBaseFactory
  {
      ...
      public string GetConnectionString()
      {
          return "Server=localhost;Port=5432;Database=test_geo;User Id=postgres;Password=postgres;";
      }
